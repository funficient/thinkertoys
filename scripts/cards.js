...
var deck = [
    ...
    new card('Helmet', 'helmet'),     new card('Cactus', 'cactus'),    new card('Cowboy', 'cowboy'),    new card('Butterfly', 'butterfly'),    new card('Cube', 'cube'),
    
    new card('X-ray', 'xray'),    new card('Money', 'money'),    new card('Magazine', 'magazine'),    new card('Ink', 'ink'),    new card('Tea', 'tea'),    
    new card('Balloon', 'balloon'),    new card('Lobster', 'lobster'),    new card('Train', 'train'),    new card('Perfume', 'perfume'),    new card('Flamingo', 'flamingo'),
    
    new card('Watermelon', 'watermelon'),   new card('Campfire', 'campfire')
...
/*
    ...
    new card('Vine', 'toast'),
    new card('Japan', 'toast'),
    new card('Fuel', 'toast'),
    new card('Shield', 'toast'),
    new card('Liver', 'toast'),
    new card('Jellyfish', 'toast'),    
    new card('Resume', 'toast'),
    new card('Scissors', 'toast'),
    new card('Olympics', 'toast'),
    new card('Cheetah', 'toast'),
    new card('Dynamite', 'toast'),
    new card('Paintbrush', 'toast'),
    new card('Lettuce', 'toast'),
    new card('Alphabet', 'toast'),
    new card('Cradle', 'toast'),
    new card('Emerald', 'toast'),
    new card('Vampire', 'toast'),
    new card('Ranch', 'toast'),
    new card('Giraffe', 'toast'),
    new card('Cobra', 'toast'),
    new card('Alligator', 'toast'),
    new card('Lantern', 'toast'),
    new card('Hawaii', 'toast'),
    
    new card('Box', 'toast'),
    new card('Airport', 'toast'),
    new card('Bagel', 'toast'),
    new card('Dancer', 'toast'),
    new card('Wig', 'toast'),
    new card('Photograph', 'toast'),    new card('Toast', 'toast'),
    new card('Network', 'toast'),
    new card('Anchor', 'toast'),
    new card('Snowflake', 'toast'),
    new card('Wand', 'toast'),
    new card('Glove', 'toast'),
    new card('Wheelbarrow', 'toast'),
    new card('Scaffold', 'toast'),
    new card('Ice cream', 'toast'),
    new card('Beard', 'toast'),
    new card('Purse', 'toast'),
    new card('Cloak', 'toast'),
    new card('Screen', 'toast'),
    new card('Logo', 'toast'),
    new card('Tape', 'toast'),
    new card('Hotel', 'toast'),
    new card('Chess', 'toast'),
    new card('Easel', 'toast'),
    new card('Frog', 'toast'),
    new card('Pilot', 'toast'),
    new card('Thesaurus', 'toast'),
    new card('Gang', 'toast'),
    new card('Casino', 'toast'),
